...
```bash
pm2 logs aprs-weather-station      # view logs
pm2 status                         # check if running
pm2 restart aprs-weather-station   # restart the service
pm2 stop aprs-weather-station      # stop the service
```
